...
echo 'Yordi, Shell Navigation, submitted
Samson, Shell Navigation, not submitted
Naol, Shell Navigation, not submitted
Melat, Shell Navigation, submitted
Kbrom, Shell Navigation, submitted' >> ./assets/submissions.txt
